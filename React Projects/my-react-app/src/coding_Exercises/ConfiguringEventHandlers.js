import './ConfiguringEventHandlers.css';
/*
...
export const user = {
  ...
  function ConfiguringEventHandlers() {
    ...
    return (
      <div id="app">
        ...
        <p id="actions">
          <button onClick = {() => {handleCreateUser('shravya')}}>Create User</button>
        </p>
      </div>
    );
  }
  
  export default ConfiguringEventHandlers;
