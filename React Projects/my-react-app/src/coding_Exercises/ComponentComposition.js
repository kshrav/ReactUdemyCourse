import ComponentCompositionCard from './ComponentCompositionCard';
/*
...
function ComponentComposition() {
  return (
    <div id="app">
      ...
      <ComponentCompositionCard name="Anthony Blake">
        <p>
      ...
      </ComponentCompositionCard>

      <ComponentCompositionCard name="Maria Miles">
        <p>
